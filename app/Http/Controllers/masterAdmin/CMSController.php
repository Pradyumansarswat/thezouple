...
class CMSController extends Controller
{
    ...
    public function cms_update(Request $request,$id)
    {
      ...
      $page_title = "Edit CMS Page - Zouple";
    ...
    {
      $data['cms_datas'] = Cms::where('cms_id',$cms_id)->get();
      $page_title = "CMS See More Page - Zouple";
