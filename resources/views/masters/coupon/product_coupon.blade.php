                        ...
                        <table id="example" class="table  table-striped table-bordered" cellspacing="0" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                         $product = json_decode($data->product_id);   
                                        foreach($product as $pro)
                                        {
                                            echo $proTitle[$pro].",<br>";
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('productCouponDelete',$data->product_coupon_id)}}" onClick="return confirm('Are you sure?');"><span class="basic_table_icon" style="font-size: 20px;color: red;margin-left: 20px;"><i class="fa fa-trash-o" aria-hidden="true"></i></span></a>
                                    </td>
                                </tr>
                                @php $i++ @endphp
                                @endforeach
