...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-shirtsinbulk"></i> Add Elements Value</h1>
            </div>
        ...
        <div class="row bg-white py-3">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <form action="{{route('attributValueSave')}}" method="post" enctype="multipart/form-data">
                      @csrf
                        <div class="row col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="attribut_name" required placeholder="Name">
                                </div>
                            </div>
