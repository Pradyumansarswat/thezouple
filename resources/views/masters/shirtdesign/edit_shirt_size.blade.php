...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-shirtsinbulk"></i> Edit Shirt Size</h1>
            </div>
        ...
        <div class="row bg-white py-3">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    @foreach($shirt_size_datass as $data)
                    <form action="{{route('shirtSizeEditSave')}}" method="post" enctype="multipart/form-data">
                      @csrf
                        <input type="hidden" value="{{$data->shirt_size_id}}" name="shirt_size_id">
