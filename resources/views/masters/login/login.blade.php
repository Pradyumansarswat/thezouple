        ...
        <div class="login-box">
            <form class="login-form" action="{{route('admin.login')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control password-field" type="password" placeholder="Password" name="password" id="admin_password">
                </div>
                <div class="form-group">
                    <div class="utility">
            ...
            <form class="forget-form" action="{{url('checklogin')}}">
