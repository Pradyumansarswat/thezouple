...
<script>
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-rss"></i> Add Blog</h1>
            </div>
        ...
        <div class="row bg-white py-3">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <form action="{{route('blog_save')}}" method="post" enctype="multipart/form-data">
                      @csrf
                        <div class="row col-sm-12">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label"> Heading <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="heading" autofocus required placeholder="Heading">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="file" name="front_image" accept="image/x-png,image/gif,image/jpeg" required>
                                </div>
                            </div>
