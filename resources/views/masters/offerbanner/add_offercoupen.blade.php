...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-newspaper-o"></i> Add Offer Coupen</h1>
            </div>
        ...
        <div class="row bg-white py-3">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <form action="{{route('offercoupen_save')}}" method="post" enctype="multipart/form-data">
                      @csrf
                        <div class="row col-sm-12">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label"> Coupen Code </label>
                                    <input class="form-control" type="text" name="coupen_code" id="coupen_code" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label"> Coupen Discount (%)</label>
                                    <input class="form-control" type="number" name="coupen_discount" id="coupen_discount" required>
                                </div>
                            </div>
                             <div class="col-sm-6">
                                <div class="form-group">
