...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            <a class="btn btn-primary icon-btn" href="{{route('mainVideo')}}"><i class="fa fa-eye"></i> Main Video List</a>
        </ul>
    </div>
    <div class="row bg-white py-3">
        <div class="col-md-12">
            ...
            <div class="card-box">
                <form action="{{route('mainvideoUpdateSave')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row col-sm-12">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                @else
                                    <div class="alert alert-info">No main video uploaded.</div>
                                @endif
                            </div>
                        </div>
                        <div class="col-sm-6">
