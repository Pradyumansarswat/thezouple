            ...
            <div class="card-box">
                <form action="{{route('sub_category_save')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row col-sm-12">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label"> Sub Category Image <span class="text-danger">(Image Dimensions - 200*182 Pixel)</span></label>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" required placeholder=" Meta Description Title"></textarea>
                            </div>
                        </div>
