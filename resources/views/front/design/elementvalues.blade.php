...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#prebtn").click(function() {
            ...
            var pre_element = $("#pre_element").val();
            if (element) {
                window.location = "preElementList?pre_element=" + pre_element + "&order_no=" + order_no + "&element_name=" + element_name;
            }
        });
        var newStr = element_name.replace(/ /g, "");
        $('#show_' + newStr).addClass('border');
...
<div class="container-fluid scrSys">
    <div class="row position-relative maxWidhtContainer ">
        ...
        <div class="col-12 btnDefault  d-flex  scrlmt  justify-content-between">
            <a href="#">
                <button type="submit" id="prebtn" class=" cta2 border-0">
...
<div class="container">
    <div class="row mb-5">
        <div class="ol-sm-12 col-md-3 col-lg-3 px-0 border pb-3 d-none d-md-block" style="background-color:black;">
            ...
            <ul class="list-unstyled m-0   dashboardLi ">
                ...
                <li class="pl-5" id="show_{{str_replace(' ', '', $element_show->name)}}">
        ...
        <div class="col-sm-12 col-md-9 col-lg-9 border py-3">
            <div class="row shirtCheck">
                ...
                @if(isset($pre_element))
                <input type="hidden" name="pre_element" id="pre_element" value="{{$pre_element}}">
                @endif
                    ...
                    <label for="{{$element->element_value_id}}" class="card" style="border-radius: 15px; overflow: hidden;">
                        ...
                        <div class="card-body cardDesign p-0 position-relative">
                            ...
                            <?php
                                ...
                                if(isset($pre_element))
                                {
                                    if($pre_element == $element->element_value_id)
                                    {
                                        $check = "checked";
                                    }
                                    else
                            ...
                            <div class='form  checkCloth bg-danger' style="border-radius: 30px;">
                                <input type="radio" name="element" id="{{$element->element_value_id}}" class='checkbox check6' value="{{$element->element_value_id}}" {{$check}}>
