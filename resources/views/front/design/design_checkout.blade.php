...
<!--===============  section =====================-->
    ...
    <div class="container-fluid  mb-5 " style="border-bottom:6px solid black;border-top:6px solid black; background-color:gray;">
        <div class="row px-5 maxWidhtContainer">
            <div class=" col-12 align-self-center col-sm-5 col-md-6  h6 m-0  text-white" >Payment</div>
            <div class="maxWidhtContainer  h6 m-0 breadThum align-self-center   col-12 d-flex  col-sm-7 col-md-6  ">
                <nav aria-label="breadcrumb m-0 ">
                    <ol class="breadcrumb m-0 bg-transparent">
                        ...
                        <li class="breadcrumb-item"><a href="" class=" h6 m-0 text-white">Payment</a></li>
    ...
    <div class="container pb-5">
        <div class="row shadow py-4 border-top">
            ...
            <form id="regForm" action="{{url('shirtCheckout')}}" class="w-100" method="post">
                @csrf
                <div class="tab">
                    ...
                    <div class="container mb-5">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-12 pb-3">
                                 {{$queryText}}
                                 <input type="hidden" name="query_Text" value="{{$queryText}}">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6  ">
                                ...
                                <div style="border:2px solid black;">
                                    <div class="d-flex  py-1 px-2 justify-content-between text-left">
                                        ...
                                        @if($currencySession == "rupee_price")
                                            <input type="hidden" name="price" value="{{$febricAmount[$dt]}}">
                                        @elseif($currencySession == "dollar_price")
                                            <input type="hidden" name="price" value="{{$febricDollrtAmount[$dt]}}">
                                        @elseif($currencySession == "euro_price")
                                            <input type="hidden" name="price" value="{{$febricEuroAmount[$dt]}}">
                                        @else
                                            <input type="hidden" name="price" value="{{$febricDollrtAmount[$dt]}}">
                                        @endif
                                    ...
                                    <div class="d-flex py-1 px-2  text-white justify-content-between text-left" style=" background-color:black; ">
                                        <div class="w-100"><b>Total <small>(Inclusive of all taxes and shipping)</small></b> </div>
                                        <div class='w-100 text-left'><i class="{{$iicon}} pr-2"></i><span><b>{{$proPrice}}</b></span>/-</div>
                                    </div>
                            ...
                            <div class="col-12 col-sm-6 my-3">
                                <a>
                                    <button onclick="continushipping()" class="cta border-0">
                                        <span>Pay Now</span>
                                        <svg width="13px" height="10px" viewBox="0 0 13 10">
                                            <path d="M1,5 L11,5"></path>
                                            <polyline points="8 1 12 5 8 9"></polyline>
                ...
                <form action="{{url('addressUpdates')}}" method="post" id="paymentfor_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="city_name" id="ecity_name" class="form-control" placeholder="City / Town" required>
