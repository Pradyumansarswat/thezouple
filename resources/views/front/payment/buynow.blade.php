...
<!--===============  section =====================-->
    ...
    <div class="container pb-5 ">
        <div class="row shadow py-4 border-top">
            ...
            <form id="regForm" action="{{url('buyNow')}}" class="w-100" method="post">
                @csrf
                <div class="tab">
                ...
                <div class="tab">
                    <div class="container">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="row py-1 my-2 border">
                                    ...
                                    <div class="col-8 col-sm-6  py-2">
                                        ...
                                        <div class="col-12 col-sm-8 py-2  px-0 d-flex align-self-center priceCart2">
                                            ...
                                            <div class="flex-w bo5 of-hidden">
                                                Quantity : <b>{{$pro_qty}}</b>
                                                <input class=" w-25 text-center num-product" type="hidden" name="pro_qty" value="{{$pro_qty}}" id="pro_qty">
                                            </div>
                                    ...
                                    <div class="col-6 col-sm-2 untPrcSm  py-2 text-right ">
                                        ...
                                        <div class=" font-weight-bold"><i class="{{$iicon}} pr-2"></i><span>{{$netAmount}}</span></div>
                                    </div>
                        ...
                        <?php
                            ...
                            foreach($cart_data as $data)
                            {
                                $total_net_amount = $netAmount * $pro_qty;
                                $total_pro_gst = $total_net_amount * $gst / 100;
                                
                                $ttl_amount = $netAmount * $pro_qty;
                            }



                            $total_final_amount = round($ttl_amount + $total_shipping);
                            ?>

                            <input type="hidden" name="net_amount" value="{{$total_net_amount}}" id="net_amount">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="border" style="margin-top:2.5rem; ">
                                ...
                                <div class="text-center py-4" style="font-size: 13px;">
                                    Items(s): <span class="font-weight-bold">1</span>
                                </div>

                                <div style="font-size:13px;" class="px-3 py-2  border-bottom d-flex justify-content-between">
                                    <div class="">Sub - Total</div>
                                    <div><i class="{{$iicon}} pr-2"></i><span id="net_amount1">{{$ttl_amount}}</span></div>
                                </div>
                                @if($total_discount > 0)
                                <!--<div style="font-size:13px;" class="px-3 py-2  border-bottom d-flex justify-content-between">
                                ...
                                <div style="font-size:13px;" class="px-3 py-2  border-bottom d-flex justify-content-between">
                                    ...
                                    <div><i class="{{$iicon}} pr-2"></i><span id="shipping1">{{$shipping}}</span></div>
                                </div>
                                <!--<div style="font-size:13px;" class="px-3 py-2  border-bottom d-flex justify-content-between">
                                    <div class="">SGST&nbsp;</div>
                                    <div><i class="fa fa-inr pr-2"></i><span id="sgst">{{$total_pro_gst/2}}</span></div>
                                </div>
                                <div style="font-size:13px;" class="px-3 py-2  border-bottom d-flex justify-content-between">
                                    <div class="">CGST&nbsp;</div>
                                    <div><i class="fa fa-inr pr-2"></i><span id="cgst">{{$total_pro_gst/2}}</span></div>
                                </div>-->

                                <div class="h6 px-3 py-3  d-flex justify-content-between">
                                    <div class="">TOTAL PAYABLE <br><small>(With Round)</small></div>
