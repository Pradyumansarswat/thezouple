        ...
        <div class=" col-12 align-self-center col-sm-12 col-md-12  h6 m-0  text-white">
            <nav aria-label="breadcrumb m-0 ">
                <ol class="breadcrumb m-0 bg-transparent">
                    ...
                    <li class="breadcrumb-item text-white">Shipping Address</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-md-3 my-4">
            <div class="bg4 py-4">
                ...
                <ul class="list-unstyled m-0   dashboardLi">
                    ...
                    <li class="dashLiactive p-t-10 p-b-10"><a href="{{url('shippingAddress')}}" class="colorwhite color0-hov">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 ">
                        <div class="border p-3">
                            ...
                            @foreach($shipping_address_list as $data)
                            <div class="border p-3 ">
                                <div class="col d-flex justify-content-between">
                                    <div class="h6">{{$data->address_name}}</div>
                                    <div class="btn m-0  p-0"><a href="{{url('shippingDelete',$data->user_information_id)}}" onClick="return confirm('Do you want to delete shipping address details?');"><span class="basic_table_icon" style="font-size: 20px;color: red;margin-left: 20px;">X</span></a></div>
                                </div>
                                <div class="col">
