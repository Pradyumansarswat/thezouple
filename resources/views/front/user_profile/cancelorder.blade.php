...
<div class="container-fluid  mb-3 " style="border-bottom:6px solid black;border-top:6px solid black; background-color:gray;">
    <div class="row px-5 maxWidhtContainer">
        <div class=" col-12 align-self-center col-sm-12 col-md-12  h6 m-0  text-white" style="letter-spacing: 4px; ">
            <nav aria-label="breadcrumb m-0 ">
                <ol class="breadcrumb m-0 bg-transparent">
                    <li class="breadcrumb-item"><a href="{{url('/')}}" class=" h6 m-0 text-white">Home</a></li>
                    <li class="breadcrumb-item text-white">Cancel order</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="container">
    <div class="row mb-5">
        <div class="col-md-3 my-4">
            <div class="bg4 py-4">
                ...
                <ul class="list-unstyled m-0   dashboardLi">
                    ...
                    <li class="dashLiactive p-t-10 p-b-10"><a href="{{url('cancleOrder')}}" class="colorwhite color0-hov">
        ...
        <div class="col-md-9 my-4">
            ...
            @if(!$cancleData->isEmpty())
            @foreach($cancleData as $data)
