...
<!--===============  section =====================-->
<script>
    function changeorder(str, order) {

        $('#cancle_order').val(str);
        $('#change_Order_text').html(str);
        $('#ordNumber').val(order);
        ...
        <div class=" col-12 align-self-center col-sm-12 col-md-12  h6 m-0  text-white">
            <nav aria-label="breadcrumb m-0 ">
                <ol class="breadcrumb m-0 bg-transparent">
                    ...
                    <li class="breadcrumb-item text-white">My order</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row mb-5">
        <div class="col-md-3 my-4">
            <div class="bg4 py-4">
                ...
                <ul class="list-unstyled m-0   dashboardLi">
                    ...
                    <li class="dashLiactive"><a href="{{url('yourOrder')}}" class="colorwhite color0-hov">
        ...
        <div class="col-md-9 my-4">
            ...
            <div class="border mb-3">
                ...
                <div class='col-12 ' style="padding:15px auto;">
                    ...
                    <div class="row py-1 my-2 border-top border-bottom">
                        ...
                        <div class="col-8 col-sm-6  py-2">
                            ...
                            <div class="pt-3 row " style="font-size:13px;">
                    ...
                    <?php $ttl_net = $ttl_net+($pro_Det[2] * $pro_Det[1])?>
                    @endforeach
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 ">
                        ...
                        @if($data->order_status !="Pending" && $data->order_status !="Rejected" && $data->order_status !="Accepted")
                        <div class="d-flex pad2 justify-content-between t-left">
                            <div class="font-weight-bold w-full">Tracking Number : </div>
                            <div class='t-left w-full'><span>{{$data->tracking_number}}</span></div>
                        </div>
                        @endif
                        @if($data->order_status !="Pending" && $data->order_status !="Rejected")
                        @if($data->user_report == "")
                        ...
                        <div class="d-flex pad2 justify-content-between t-left">
                            ...
                            <div class='t-left w-full'>
                                ...
                                <div onclick="changeorder('EXCHANGE ORDER','{{$data->order_number}}')" class="btn btn-dark m-t-10 prcPay2 mt-2" data-toggle="modal" data-target="#cancelOrder">Exchange Order</div>
                    ...
                    <div class="col-12 col-sm-6 ">
                        <div class="d-flex pad justify-content-between t-left" style="border-top:2px solid black;">
                            <div class=" w-full">Sub Total : </div>
                            <?php $currenceType = $data->amount_type; ?>
                            @if($currenceType == "rupee_price")
                            <div class='t-left w-full'><span><i class="fa fa-inr"></i>{{$ttl_net}}</span>/-</div>
                            @elseif($currenceType == "dollar_price")
                            <div class='t-left w-full'><span><i class="fa fa-usd"></i>{{$ttl_net}}</span>/-</div>
                            @elseif($currenceType == "euro_price")
                            <div class='t-left w-full'><span><i class="fa fa-eur"></i>{{$ttl_net}}</span>/-</div>
                            @else
                            <div class='t-left w-full'><span><i class="fa fa-usd"></i>{{$ttl_net}}</span>/-</div>
                            @endif
                        </div>
                        ...
                        <div class="d-flex font-weight-bold pad2 justify-content-between t-left">
                            <?php $currenceType = $data->amount_type; ?>
                            @if($currenceType == "rupee_price")
                            <div class=" w-full"><b>Total </b><small>(Round Off )</small>: </div>
                            @elseif($currenceType == "dollar_price")
                            <div class=" w-full"><b>Total </b><small>( Round Off )</small>: </div>
                            @elseif($currenceType == "euro_price")
                            <div class=" w-full"><b>Total </b><small>( Round Off )</small>: </div>
            ...
            <div class="border mb-3">
                ...
                <h6 class="border px-2 py-2">{{$data->query_Text}}</h6>
                <div class="row">
                    <div class="col-12 col-sm-6 ">
                        <div class="d-flex pad justify-content-between t-left">
                            <div class="font-weight-bold w-full">Order Date : </div>
            ...
            @else
            <div class="px-4 col-12 py-3 m-0 text-danger border">No order there.</div>
            @endif
        ...
        <div class="modal-content">
            ...
            <form action="{{url('cancleOrderByUserSave')}}" method="post" name="form">
                ...
                <div class="modal-body">
                    ...
                    <div>Request you to please share the reason for the <span id="change_Order_text">cancelation</span>.</div>
                    <br>
