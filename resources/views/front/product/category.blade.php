...
<div class="container-fluid  mb-3" style="border-bottom:6px solid black;border-top:6px solid black; background-color:gray;">
    <div class="row px-0 px-sm-5 maxWidhtContainer">
        <div class=" col-12 align-self-center col-sm-12 col-md-12  h5 m-0  text-white">
...
<div class="container-fluid px-0 px-sm-5 ">
    <div class="row py-4 px-0 px-sm-5 maxWidhtContainer">
        ...
        <div class="col-lg-3 filterSm  border py-4">
            ...
            <hr>
            <div class="p-0 col-12 pt-2 m-0 h5 proListSortName text-danger">
                SHOP BY
            </div>
            <?php 
        ...
        ?>
            <div class="col-12 pt-3 pb-2 h6 m-0">
            ...
            <div class="col-12 py-2 h6 m-0">
                <u>Rating</u>
            </div>
            <div class="col-12">
                <div class="p-0 m-0"> <input type="checkbox" id="star_5" style="width:fit-content" value="star-5" name="review"><label for="star_5" class="px-4 check_box">
                ...
                <div class="p-0 m-0">
                    <input type="checkbox" id="star_4" style="width:fit-content" value="star-4" name="review"><label for="star_4" class="px-4 check_box">
                        <i class="fa fa-star text-warning class=" p-0 m-0""></i>
                        <i class="fa fa-star text-warning class=" p-0 m-0""></i>
                        <i class="fa fa-star text-warning class=" p-0 m-0""></i>
                        <i class="fa fa-star text-warning class=" p-0 m-0""></i>
            ...
            <div class="p-0 col-12 pt-3 m-0 h5 proListSortName text-danger">
                MY WISH LIST
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12  py-4 col-sm-6 col-md-4 col-lg-12 d-flex">
                    ...
                    <div class="col-8 pr-0">
                        ...
                        <?php 
                            ...
                            $proDiscount = $wish->product_discount;
                ...
                @endforeach
                @else
                <div class="px-4 col-12 pt-3 m-0">No Product in Wishlist.</div>
                                ...
                                <a href="{{url('product', $data->slug)}}">
                                    <div class="card-footer text-white" style="background-color:black;">
                                        ...
                                        <div class="font-weight-normal m-0 text-white proTitleText" style="font-size:14px">
                                            ...
                                            echo $description = Str::words($des, '3');
                                        ?>
                                        </div>
